%% Análisis Cubesat URJC
clear all
clc
close all

%% cargar datos matlab - (ojo al tamaño)
load('TestC290426.mat')
%load('TestC060526.mat')

%% Asignar nombres por comodidad
t = Data1_time_AI_1__1__minus;
winlen = size(Data1_AO_3__39__Shaker_grande,1); %la variable shaker cambia en cada export

exc = Data1_AO_3__39__Shaker_grande;
...
for w=1:4
    ...
    %tfestimate(exc,acel(w,:),hann(winlen), 0.5*winlen, [],Sample_rate) auto FRF
